...
public class Main {
	...
	public static ArrayList<String> getWordLadderDFS(String start, String end) {
    	...
    	if(!dictionary.contains(start) || !dictionary.contains(end) || start.equals(end)){
    		temp.add(start);
    		temp.add(end);
    		return temp;
    	}

    	temp = recursiveDFS(start, end);
        initialize();
	 ...
	 * @param two Strings as the start word and the end word
	 ...
	 * @param two Strings and dictionary
